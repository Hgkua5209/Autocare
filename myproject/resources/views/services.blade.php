...
<div class="max-w-7xl mx-auto px-6 py-10">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-neutral-800 text-white rounded-xl p-6 flex flex-col justify-between min-h-[220px]">
            ...
            <button onclick="window.location.href='{{ route('checksurvey') }}'" class="mt-6 border border-gray-400 rounded px-4 py-1 self-center">Explore</button>
        </div>
        ...
        <div class="bg-neutral-800 text-white rounded-xl p-6 flex flex-col justify-between min-h-[220px]">
            <div>
                <h2 class="text-lg font-semibold mb-2">Analytics Dashboard</h2>
                <ul class="text-sm text-gray-300 list-disc list-inside space-y-1">
                    <li>View Patterns</li>
            ...
            <button onclick="window.location.href='{{ route('dashboard') }}'" class="mt-6 border border-gray-400 rounded px-4 py-1 self-center">View</button>
        </div>
